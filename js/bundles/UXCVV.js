var pageComponent =
webpackJsonppageComponent([8,13,14,15,16,17],[
/* 0 */
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UXCVV", function() { return UXCVV; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
/**
 * @fileoverview Templates in namespace UXCVV.
 * @public
 */

goog.module('UXCVV.incrementaldom');
      ...
      ie_open('ol');
        ...
        ie_open('li');
          ...
          ie_open('code');
            itext('yarn');
          ie_close('code');
          itext(' to install dependencies;');
        ie_close('li');
        ie_open('li');
          itext('Run ');
          ie_open('code');
            itext('yarn build:nix');
          ie_close('code');
          itext(' to build or ');
          ie_open('code');
            itext('yarn watch:nix');
          ie_close('code');
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'UXCVV.render';
}
...
class UXCVV extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(UXCVV, templates);
...
var UXCVV = function (_Component) {
  _inherits(UXCVV, _Component);

  function UXCVV() {
    _classCallCheck(this, UXCVV);

    return _possibleConstructorReturn(this, (UXCVV.__proto__ || Object.getPrototypeOf(UXCVV)).apply(this, arguments));
  }
...
_metalSoy2.default.register(UXCVV, _indexSoy2.default);

exports.default = UXCVV;
