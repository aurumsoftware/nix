var pageComponent =
webpackJsonppageComponent([0,13,14,15,16,17],[
/* 0 */
...
function $header(opt_data, opt_ignored, opt_ijData) {
  ie_open('header', null, null,
    ...
    ie_open('div', null, null,
        'class', 'container');
      ie_open('div', null, null,
          'class', 'icon-title-header');
        ie_open('img', null, null,
            'src', '/images/nix-white.svg');
        ie_close('img');
      ie_close('div');
      ie_open('div', null, null,
          'class', 'title-section');
        ie_open('h1');
          itext('Created to facilitate the customization of the structure of your project.');
        ie_close('h1');
      ie_close('div');
      ie_open('div', null, null,
          'class', 'header-cta');
      ...
      ie_open('div', null, null,
        ...
        ie_open('div', null, null,
          ...
          ie_open('a', null, null,
              ...
              'aria-label', 'Star aurumsoftware/nix on GitHub');
            itext('Star');
          ie_close('a');
        ie_close('div');
        ie_open('div', null, null,
          ...
          ie_open('a', null, null,
              'class', 'github-button',
              'href', 'https://github.com/aurumsoftware/nix/fork',
              'data-size', 'large',
              'data-show-count', 'true',
              'aria-label', 'Fork aurumsoftware/nix on GitHub');
            itext('Fork');
          ie_close('a');
        ie_close('div');
      ie_close('div');
      ...
      ie_open('div', null, null,
        ...
        ie_open('div', null, null,
          ...
          ie_open('h3', null, null,
              'class', 'about-title');
            itext('A ess\u00EAncia da nossa empresa s\u00E3o as pessoas');
          ie_close('h3');
          ie_open('p', null, null,
              'class', 'about-description');
            itext(' Somos 90 \u00E1ureos trabalhando exclusivamente para desenvolver e manter a qualidade dos nossos produtos e servi\u00E7os. Para n\u00F3s, gostar do que fazemos faz parte do trabalho! E levamos isso muito a s\u00E9rio. Temos prazer e orgulho de sermos \u00E1ureos. Confiamos na tecnologia e reconhecemos nossos talentos. Valorizamos nossa gest\u00E3o horizontal e estimulamos a cultura colaborativa. Temos muitos sotaques e estamos localizados em tr\u00EAs lugares diferentes. Nossa sede fica em Florian\u00F3polis e nossas filiais em S\u00E3o Paulo e Rio de Janeiro.');
          ie_close('p');
          ie_open('br');
          ie_close('br');
          ie_open('br');
...
var _indexSoy = __webpack_require__(326);
