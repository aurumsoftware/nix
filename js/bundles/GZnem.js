var pageComponent =
webpackJsonppageComponent([10,13,14,15,16,17],[
/* 0 */
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GZnem", function() { return GZnem; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(2);
...
/**
 * @fileoverview Templates in namespace GZnem.
 * @public
 */

goog.module('GZnem.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param288 = function() {
    ie_open('article', null, null,
        'id', '2');
      ie_open('p');
        itext('These properties require ');
        ie_open('code');
          itext('display: flex');
        ie_close('code');
        itext(' in the parent for working.');
      ie_close('p');
      ie_open('p');
        itext('Learn flexbox with ');
        ie_open('a', null, null,
    ...
    ie_open('article', null, null,
      ...
      ie_close('h2');
      ie_open('p');
        itext('This defines the size of an element before the remaining space is distributed.');
      ie_close('p');
      ie_open('table');
        ie_open('thead');
          ie_open('tr');
        ...
        ie_open('tbody');
          ie_open('tr');
            ...
            ie_open('td', null, null,
                'style', 'text-align:left');
              itext('Defines an automatic size');
            ie_close('td');
          ie_close('tr');
          ie_open('tr');
            ie_open('td', null, null,
          ...
          ie_open('tr');
            ...
            ie_open('td', null, null,
                'style', 'text-align:left');
              itext('Defines all available space');
            ie_close('td');
          ie_close('tr');
        ie_close('tbody');
      ie_close('table');
      $templateAlias2({code: '<div class="nix-flex_1"></div>', mode: 'xml'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', '9');
      ie_open('h2');
      ...
      ie_open('p');
        ie_open('code');
          itext('order');
        ie_close('code');
        itext(' defines the order of an element from 0 until 5.');
      ie_close('p');
      ie_open('table');
        ie_open('thead');
          ie_open('tr');
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'GZnem.render';
}
...
class GZnem extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(GZnem, templates);
...
var _flexboxSoy = __webpack_require__(232);
...
var GZnem = function (_Component) {
  _inherits(GZnem, _Component);

  function GZnem() {
    _classCallCheck(this, GZnem);

    return _possibleConstructorReturn(this, (GZnem.__proto__ || Object.getPrototypeOf(GZnem)).apply(this, arguments));
  }
...
_metalSoy2.default.register(GZnem, _flexboxSoy2.default);

exports.default = GZnem;
