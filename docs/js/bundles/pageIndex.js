...
goog.loadModule(function (exports) {
  ...
  function $header(opt_data, opt_ignored, opt_ijData) {
    ...
    ie_open('div', null, null, 'class', 'icon-title-header');
    ie_open('svg', null, null, 'xmlns', 'http://www.w3.org/2000/svg', 'viewBox', '-1 1 24 24');
    ie_void('polygon', null, null, 'points', '21.79 1.81 0 1.81 0 23.62 14.53 23.62 14.53 16.35 7.26 16.35 7.26 9.08 14.53 9.08 14.53 16.35 21.79 16.35 21.79 1.81');
    ie_close('svg');
    ie_close('div');
    ...
    ie_open('a', null, null, 'href', '/docs', 'class', 'btn btn-accent');
  ...
  function $why(opt_data, opt_ignored, opt_ijData) {
    ...
    itext('A ess\xEAncia da nossa empresa s\xE3o as pessoas');
    ie_close('h3');
    ie_open('p', null, null, 'class', 'about-description');
    itext(' Somos 90 \xE1ureos trabalhando exclusivamente para desenvolver e manter a qualidade dos nossos produtos e servi\xE7os. Para n\xF3s, gostar do que fazemos faz parte do trabalho! E levamos isso muito a s\xE9rio. Temos prazer e orgulho de sermos \xE1ureos. Confiamos na tecnologia e reconhecemos nossos talentos. Valorizamos nossa gest\xE3o horizontal e estimulamos a cultura colaborativa. Temos muitos sotaques e estamos localizados em tr\xEAs lugares diferentes. Nossa sede fica em Florian\xF3polis e nossas filiais em S\xE3o Paulo e Rio de Janeiro.');
    ie_close('p');
    ie_open('br');
    ie_close('br');
    ie_open('br');
    ie_close('br');
    ie_open('a', null, null, 'href', '/docs', 'class', 'btn btn-link');
    ie_void('span', null, null, 'class', 'icon-16-circle-arrow');
    itext(' Fa\xE7a parte');
    ie_close('a');
    ie_close('div');
